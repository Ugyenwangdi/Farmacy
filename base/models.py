...
class Product(models.Model):
    ...
    unit = models.CharField(max_length=100, null=True, blank=True, default="kg")
...
class Transaction(models.Model):
    ...
    transactionNo = models.TextField(null=True, blank=True)
    createdAt = models.DateTimeField(auto_now_add=True)
    _id = models.AutoField(primary_key=True, editable=False)

    def __str__(self):
        return str(self.name) + '-' + str(self.transactionNo) 
